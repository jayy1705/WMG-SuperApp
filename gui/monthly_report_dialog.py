...
gui/step3_analyze.py, which only opens it once it has confirmed there is
outlet/month data to choose from.
...
class MonthlyReportDialog(tk.Toplevel):
    ...
    def __init__(self, parent, outlets: list, months: list):
        ...
        tk.Button(
            nav, text="Generate...", command=self._on_generate, bg="#4CAF50", fg="white"
        ).pack(side="right")
